...
if nome_remover in contatos:
    contatos.pop(nome_remover)# remove pela chave
    print(f"\nContato {nome_remover} removido.")
else:
    print(f"\nContato {nome_remover} não encontrado para remoção.")

nome_remover2 = "Elisa"
if nome_remover2 in contatos:
    contatos.pop(nome_remover2)
    print(f"\nContato {nome_remover2} removido.")
else:
    print(f"\nContato {nome_remover2} não encontrado para remoção.")
...
nome_update = "Ana"
telefone_update = "9999-0000"

if nome_update in contatos:
    print(f"\nAtualizando telefone do contato {nome_update}.")
    contatos[nome_update] = telefone_update
else:
    print(f"\nContato {nome_update} não encontrado para atualizar.")


print("Contatos após adição e atualização:")
for nome, telefone in contatos.items():
    print(f"{nome}: {telefone}")
...
# Cada chave é única e mapeia para um valor. São ótimos para representar dados
# que associam uma informação a outra, como um cadastro, onde a chave pode ser
# o nome e o valor o telefone, por exemplo.
...
# Convertendo listas em conjuntos para operações de conjuntos
...
conjunto.discard(2)  # remove 2 (sem erro se não existir)
